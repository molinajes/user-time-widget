...
var _Chart = __webpack_require__(159);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./GAUsersTimeWidget.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./GAUsersTimeWidget.scss");
...
var _reactGoogleCharts = __webpack_require__(141);
...
};var columns = [{ type: 'string', label: 'Day' }, { type: 'number', label: 'Total time' }, { type: 'number', label: 'Avg session duration' }, { type: 'number', label: 'Avg time' }];

definejs('GAUsersTimeWidget', function create() {

  return {
    createComponent: function createComponent(React, Component) {
      return function (_Component) {
        _inherits(GAUsersTimeWidget, _Component);

        function GAUsersTimeWidget(props) {
          _classCallCheck(this, GAUsersTimeWidget);

          var _this = _possibleConstructorReturn(this, (GAUsersTimeWidget.__proto__ || Object.getPrototypeOf(GAUsersTimeWidget)).call(this, props));
          ...
          _this.init = function () {
            ...
            gapi.analytics.ready(function (a) {
              gapi.analytics.auth.on('success', function (response) {
                ...
                _this.loadAnalytics(_this.state.activeAttr);
              });
              doAuth();
            });
          };

          _this.loadAnalytics = function () {
            var self = _this;
        ...
        _createClass(GAUsersTimeWidget, [{
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement('div', { ref: function ref(node) {
                  return _this2.authButtonNode = node;
                } }),
              this.state.ready ? React.createElement(_reactGoogleCharts.Chart, {
                chartType: 'LineChart',
...
// module
exports.push([module.i, ".text-widget {\n  width: 365px;\n  height: 100%;\n  padding: 11px 9px; }\n  .text-widget__content {\n    padding: 0px;\n    max-width: 100%;\n    max-height: 100%;\n    width: 100%;\n    height: 100%;\n    font-family: 'Roboto';\n    font-size: 16px;\n    line-height: 1.38;\n    color: #394549;\n    border: none;\n    resize: none;\n    font-weight: normal;\n    outline: none; }\n", ""]);
...
var _DEFAULT_CHART_COLORS = __webpack_require__(161);

var _DEFAULT_CHART_COLORS2 = _interopRequireDefault(_DEFAULT_CHART_COLORS);

var _GoogleChartLoader = __webpack_require__(160);
...
var script = typeof window !== 'undefined' ? __webpack_require__(152) : function (link, _ref) {
